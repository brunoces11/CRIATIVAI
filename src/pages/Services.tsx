...
const services = [
  ...
  },
  {
    ...
    text: "AI-assisted development done intelligently, from system planning and architecture to development, testing, deployment, and optimized use of AI across the full build process.",
    icon: "system",
  },
  {
    index: "04",
